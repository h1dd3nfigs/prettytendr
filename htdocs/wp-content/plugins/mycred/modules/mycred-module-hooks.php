...
if ( defined( 'myCRED_VERSION' ) ) {
	 ...
	 * @version 1.0
	 */
	add_filter( 'mycred_setup_hooks', 'WooCommerce_Product_Reviews_Hook' );
	function WooCommerce_Product_Reviews_Hook( $installed ) {
