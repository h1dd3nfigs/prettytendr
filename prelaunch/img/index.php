			...
			if(filter_var($email, FILTER_VALIDATE_EMAIL)){ //sanitize email input and check that it's a valid email address	
				...
				if(strlen($sanitized_email)>40||strlen($sanitized_email)>40 || strlen($sanitized_email)>40){
					...
					//echo '*Please adhere to the max length of fields.';
							...
							if($query_num_rows==1){
								$alreadySignedUp = '*The email \''.$sanitized_email. '\' is already on our mailing list. No need to sign up again.';
								...
								if($query_run){
									...
									// echo '<p class="subtitle">Thanks for signing up!</p>';
...
?>
    ...
    <div class="intro-segment">
        ...
        <video class="motion" autoplay loop muted>
...
<div class="row">
    ...
    <form action="index.php" method="POST">
        <div class="row">
            ...
            <div class="small-10 small-centered large-uncentered large-offset-1 large-3 columns">
            	...
            	<span style="font-family:ltc-bodoni-175, serif; font-style: italic ;" ><?php echo $cantJoinNowErr;?></span>
            	<span style="font-family:ltc-bodoni-175, serif; font-style: italic ;" ><?php echo $nameErr;?></span>
            	<span style="font-family:ltc-bodoni-175, serif; font-style: italic ;" ><?php echo $validEmailErr;?></span>
            	<span style="font-family:ltc-bodoni-175, serif; font-style: italic ;" ><?php echo $tooLongErr;?></span>
            ...
            <div class="small-10 small-centered large-uncentered large-3 columns">
            	...
            	<span class="subtitle" ><?php echo $successMsg;?></span>
    ...
    <div class="row">
        <div class="small-10 small-centered large-6 large-centered columns">
            <span class="subtitle" ><?php echo $alreadySignedUp;?></span>
  ...
  <!--Ruth's form
  <form action="splashpage.php" method="POST" onsubmit="checkForm()">
	Email:<br><input type="text" name="email" maxlength="40" value="<?php if(isset($_POST['email'])){echo $email;}?>" ><br><br>
	First Name:<br><input type="text" name="firstname" maxlength="40" value="<?php if(isset($_POST['firstname'])){echo $firstname;}?>"><br><br>
	Last Name:<br><input type="text" name="lastname" maxlength="40" value="<?php if(isset($_POST['lastname'])){echo $lastname;}?>"><br><br>
